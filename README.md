...
![Launch installer prompt](assets/readme/installer-prompt.png)

If you launch the installer, then you'll see a progress notification for the duration of the
install:

![Progress notification](assets/readme/progress-notification.png)
...
![Log view](assets/readme/log-view.png)
...
![API Key prompt](assets/readme/api-key-prompt.png)
...
![Installation complete](assets/readme/done.png)
